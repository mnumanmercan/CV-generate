  ...
  >
    ...
    >
      <div style="display: flex; align-items: center; gap: 6px">
        <p style="font-size: 11.5px; font-weight: 700; color: #111827; margin: 0">
          {{ project.name }}
        </p>
        <a
          v-if="project.link"
      ...
      <p style="font-size: 10.5px; color: #374151; margin: 3px 0 4px 0; line-height: 1.6">
        {{ project.description }}
      </p>
      <div v-if="project.techStack.length" style="display: flex; flex-wrap: wrap; gap: 3px">
        <span v-for="tech in project.techStack" :key="tech" class="skill-chip">
          {{ tech }}
        </span>
      </div>
    </div>
