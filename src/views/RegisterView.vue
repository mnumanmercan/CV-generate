<script setup lang="ts">
  ...
  /* ── Password strength ──────────────────────────────────────────────── */
  // Earthy semantic palette — warm reds and ochres on paper, never neon.
  ...
  const strengthColor = computed(() => {
    // Sienna-ink red → ochre → mustard → ink-green
    const colors = ['', '#B42727', '#C26A1A', '#A38421', '#15803D']
...
<template>
  <div class="min-h-screen flex flex-col" style="background: var(--paper)">
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-14">
      <div class="w-full max-w-[460px] animate-slide-up">
        ...
        <p class="text-center text-[14.5px] text-muted mb-9 leading-[1.55]">
          Save your work across devices, export polished PDFs,<br class="hidden md:block" />
          ...
          <form class="space-y-4" novalidate @submit.prevent="handleSubmit">
            ...
            <div>
              ...
              <p
                ...
                class="mt-1.5 mono-eyebrow text-[10px]"
                style="color: #B42727"
            ...
            <div class="flex items-start gap-2.5 pt-1">
              ...
              <label
                for="reg-terms"
                class="text-[13.5px] text-muted cursor-pointer leading-relaxed"
              >
                I agree to the
                <a
                  href="#"
                  class="font-medium hover:opacity-80 transition-colors underline-offset-4 hover:underline"
                  :style="{ color: 'var(--accent)' }"
                  @click.prevent
                >Terms of Service</a>
                and
