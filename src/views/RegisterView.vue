      ...
      >
        <div class="relative w-8 h-8 shrink-0 transition-transform duration-300 group-hover:scale-105">
          <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
            <defs>
              <linearGradient id="logo-rg" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stop-color="#06B6D4" />
                <stop offset="50%" stop-color="#0891B2" />
                <stop offset="100%" stop-color="#0D9488" />
              </linearGradient>
              <linearGradient id="logo-sheen-rg" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stop-color="rgba(255,255,255,0.20)" />
                <stop offset="100%" stop-color="rgba(255,255,255,0)" />
              </linearGradient>
            </defs>
            <path d="M8 4 H24 L30 14 L16 30 L2 14 Z" fill="url(#logo-rg)" />
            <path d="M8 4 H24 L30 14 H2 Z" fill="url(#logo-sheen-rg)" />
    ...
    <main class="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
      <div class="w-full max-w-md animate-slide-up">
        ...
        >
          ...
          <div
            class="h-1 w-full"
            style="background: linear-gradient(90deg, #0D9488 0%, #06B6D4 50%, #0891B2 100%)"
          />

          <div class="p-8">
            <!-- Heading -->
            <div class="text-center mb-8">
              <h1 class="text-2xl font-bold text-primary mb-1.5">Create your account</h1>
              <p class="text-sm text-secondary">Build and export your professional resume for free</p>
            </div>
            ...
            <form class="space-y-4" novalidate @submit.prevent="handleSubmit">
              <!-- Full name -->
              <div>
                <label class="block text-sm font-medium text-primary mb-1.5" for="reg-name">
                  Full name
                </label>
                <input
                  id="reg-name"
              ...
              <!-- Email -->
              <div>
                <label class="block text-sm font-medium text-primary mb-1.5" for="reg-email">
                  Email address
                </label>
                <input
                  id="reg-email"
              ...
              <!-- Password -->
              <div>
                <label class="block text-sm font-medium text-primary mb-1.5" for="reg-password">
                  Password
                </label>
                <div class="relative">
                  <input
                ...
                <div v-if="password" class="mt-2">
                  <div class="flex items-center gap-1.5 mb-1">
                    <div
                      ...
                      :style="{
                        background: i <= passwordStrength ? strengthColor : 'rgb(var(--overlay-rgb) / 0.12)'
                      }"
                    />
                  </div>
              ...
              <!-- Confirm password -->
              <div>
                <label class="block text-sm font-medium text-primary mb-1.5" for="reg-confirm">
                  Confirm password
                </label>
                <div class="relative">
                  <input
              ...
              <div class="flex items-start gap-2.5 pt-0.5">
                ...
                <label
                  for="reg-terms"
                  class="text-sm text-secondary cursor-pointer leading-relaxed"
                >
                  I agree to the
                  <a href="#" class="font-medium hover:opacity-80 transition-colors" style="color: var(--accent)" @click.prevent>Terms of Service</a>
                  and
                  <a href="#" class="font-medium hover:opacity-80 transition-colors" style="color: var(--accent)" @click.prevent>Privacy Policy</a>
                </label>
              </div>
