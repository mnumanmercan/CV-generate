<script setup lang="ts">
  ...
  onMounted(() => { document.title = 'Create account — Resumark' })
</script>
                ...
                <div v-if="password || passwordAttempted" class="mt-3">
                  ...
                  <div class="flex items-center gap-1 mb-3">
                    <div
                      ...
                      :style="{ background: i <= passwordStrength ? strengthMeta.color : 'rgba(0,0,0,0.08)' }"
                    />
                    <span
...
@keyframes error-flash {
  0%   { box-shadow: 0 0 0 0 rgba(180, 39, 39, 0),    inset 0 0 0 0   rgba(180, 39, 39, 0); }
  18%  { box-shadow: 0 0 0 4px rgba(180, 39, 39, 0.16), inset 0 0 0 1.5px rgba(180, 39, 39, 0.5); }
  72%  { box-shadow: 0 0 0 4px rgba(180, 39, 39, 0.16), inset 0 0 0 1.5px rgba(180, 39, 39, 0.5); }
  100% { box-shadow: 0 0 0 0 rgba(180, 39, 39, 0),    inset 0 0 0 0   rgba(180, 39, 39, 0); }
}
